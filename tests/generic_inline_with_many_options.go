...
//go:generate minimock -i github.com/gojuno/minimock/v3/tests.genericInlineUnionWithManyTypes -o ./tests/generic_inline_with_many_options.go -n GenericInlineUnionWithManyTypesMock
