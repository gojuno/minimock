...
//go:generate minimock -i github.com/gojuno/minimock/v3/tests.genericOut -o generic_out.go -n GenericOutMock -p tests
...
func (mmName *mGenericOutMockName[T]) Optional() *mGenericOutMockName[T] {
