...
generate:
	...
	go run ./cmd/minimock/minimock.go -i ./tests.Formatter -o ./tests/formatter_with_test_package_suffix_mock.go -t
...
clean:
	...
	[ -e ./tests/formatter_with_test_package_suffix_mock_test.go.test_origin ] && mv -f ./tests/formatter_with_test_package_suffix_mock_test.go.test_origin ./tests/formatter_with_test_package_suffix_mock_test.go
...
test_save_origin:
	...
	[ -e ./tests/formatter_with_test_package_suffix_mock_test.go.test_origin ] || cp ./tests/formatter_with_test_package_suffix_mock_test.go ./tests/formatter_with_test_package_suffix_mock_test.go.test_origin
...
test: test_save_origin generate
	...
	diff ./tests/formatter_with_test_package_suffix_mock_test.go ./tests/formatter_with_test_package_suffix_mock_test.go.test_origin
